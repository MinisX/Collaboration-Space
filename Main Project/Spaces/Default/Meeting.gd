...
# Names for remote participants in id:participant data format.
...
#			participant.set_participant_name(participant_data["Name"])
...
#			participant.set_participant_name(participants[p_id]["Name"])
